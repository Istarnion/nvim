...
require('packer').startup(function(use)
    ...
    use 'Yggdroot/indentLine'       -- display thin vertical lines at indentation
    use 'tpope/vim-surround'        -- Commands to add/remove/change surrounding stuff

    use 'tpope/vim-fugitive'        -- git CLI wrapper
    use 'vim-airline/vim-airline'   -- More fancy status line
    use 'airblade/vim-gitgutter'    -- Shows git diff in the gutter. Integrates also woth the statusline
...
-- nvim-cmp setup
-- TODO(istarnion): Add in support for the snippets: https://github.com/quangnguyen30192/cmp-nvim-ultisnips
